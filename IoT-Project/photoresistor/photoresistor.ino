...
const char* ssid = "QuerizonNet37";
const char* password = "4389272834";
const char* mqtt_server = "192.168.0.179"; // at home
//const char* ssid = "Mezushrai";
//const char* password = "pupkazalupka";
//const char* mqtt_server = "172.20.10.3"; 
WiFiClient tiqwa;
PubSubClient client(tiqwa);
void setup_wifi() {
 delay(10);
...
void loop() {
  ...
  if (!client.connected()) {
   ...
   if(!client.loop())
   client.connect("tiqwa");

   char msg_out[20];
   sprintf(msg_out, "%d",sensorValue);
   client.publish("lightIntensity",msg_out);
  delay(5000);
